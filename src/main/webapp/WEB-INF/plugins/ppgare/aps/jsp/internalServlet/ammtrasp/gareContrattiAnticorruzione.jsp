			...
			<s:if test="%{listaAppalti.size() > 0}">
				...
				<div class="table-container">
					<table id="tableBandi" class="info-table source-popup">
						<caption style="display:none;"><wp:i18n key="LABEL_190_BANDI_CONTRATTI_AGGIUDICATI_SUMMARY" /></caption>
						<thead>
							<tr>
						...
						<tbody>
							<s:iterator var="riga" value="listaAppalti">
								<tr>
									...
									<td>
									    <s:if test="%{partecipante.length > 0}">
                                            <ul>
									...
									<td>
									    <s:if test="%{aggiudicatario.length > 0}">
                                            <ul>
