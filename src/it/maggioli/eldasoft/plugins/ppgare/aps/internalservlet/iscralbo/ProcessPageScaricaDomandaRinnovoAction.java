...
public class ProcessPageScaricaDomandaRinnovoAction extends ProcessPageScaricaDomandaIscrizioneAction {
	...
	public String next() {
		...
		this.nextResultAction = rinnovoHelper.getNextAction(WizardIscrizioneHelper.STEP_SCARICA_ISCRIZIONE);	
		return target;
	}
	...
	public String back() {
		...
		this.nextResultAction = rinnovoHelper.getPreviousAction(WizardRinnovoHelper.STEP_SCARICA_ISCRIZIONE);
		return target;
	}
