...
<s:if test="%{tipologia == 2}">
	...
	<c:set var="backTo"><wp:i18n key='LINK_DETTAGLIO_ESITO_BACK_TO_GARA'/></c:set>
...
<div class="portgare-view">
	...
	<h2><wp:i18n key="TITLE_PAGE_ISCRALBO_RICHIESTA_AGGIORNAMENTO_A"/> <c:out value="${titolo}"/></h2>

	<p><wp:i18n key="LABEL_RICHIESTA_AGGIORNAMENTO_A_ISCRALBO_1"/></p>
	<p>
