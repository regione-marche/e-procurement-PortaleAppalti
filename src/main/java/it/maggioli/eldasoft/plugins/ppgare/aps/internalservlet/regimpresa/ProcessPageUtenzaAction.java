...
public class ProcessPageUtenzaAction extends AbstractProcessPageAction {
    ...
    public void validate() {
		...
		try {
		    ...
		    if(customConfigManager.isVisible("REG-IMPRESA", "CONSENSO-EXTRA") && this.consensoExtra == null){
		    	this.addFieldError(this.getI18nLabel("LABEL_CONSENSO_EXTRA", this.getLocale().getLanguage()),this.getI18nLabel("LABEL_CONSENSO_EXTRA", this.getLocale().getLanguage()) +": " +  this
						.getText("Errors.mandatory"));
		    }
    ...
    public String next() {
		...
		if (registrazioneHelper == null) {
		    ...
		    registrazioneHelper.setConsensoExtra(this.consensoExtra);
