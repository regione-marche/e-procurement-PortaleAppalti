...
<div class="portgare-view">
	...
	<div class="azioni">
		<form action="<wp:action path="/ExtStr2/do/FrontEnd/GareTel/cancelOffTec.action" />" method="post" class="azione">
			...
			<div>
				<input type="hidden" name="codice" value="${sessionScope.offertaTecnica.gara.codice}" />
				<input type="hidden" name="operazione" value="${inviaOfferta}"/>
				<input type="hidden" name="progressivoOfferta" value="${sessionScope.offertaTecnica.progressivoOfferta}" />
