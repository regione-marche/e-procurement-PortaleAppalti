...
<div class="portgare-view">
	...
	<jsp:include page="/WEB-INF/plugins/ppcommon/aps/jsp/balloon_info.jsp">
			<jsp:param name="keyMsg" value="BALLOON_AGG_IMPRESA_ALTRI_DATI_ANAGR_IMPRESA"/>
	</jsp:include>

	<jsp:include page="/WEB-INF/plugins/ppcommon/aps/jsp/skip_form_buttons.jsp" />

	<form action="<wp:action path="/ExtStr2/do/FrontEnd/DatiImpr/processPageAltriDatiAnagrImpresa.action" />" method="post">
