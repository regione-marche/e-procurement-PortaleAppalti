...
<div class="portgare-view">
	...
	<div class="azioni">
		<form action="<wp:action path="/ExtStr2/do/FrontEnd/GareTel/cancelOffTel.action" />" method="post" class="azione">
			...
			<div>
				<input type="hidden" name="codice" value="${sessionScope.offertaEconomica.gara.codice}" />
				<input type="hidden" name="operazione" value="${inviaOfferta}"/>
				<input type="hidden" name="progressivoOfferta" value="${sessionScope.offertaEconomica.progressivoOfferta}" />
