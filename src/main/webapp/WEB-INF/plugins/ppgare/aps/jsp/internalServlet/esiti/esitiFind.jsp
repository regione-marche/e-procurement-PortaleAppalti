...
<div class="portgare-list">
	...
	<form class="form-ricerca" action="<wp:action path="/ExtStr2/do/FrontEnd/Esiti/search.action" />" method="post" >
		...
		<fieldset>
			...
			<div class="fieldset-row first-row special">
				...
				<div class="element">
					<a href="<wp:action path="/ExtStr2/do/FrontEnd/Bandi/openSearch.action" />" title="<wp:i18n key="LABEL_GO_TO_SEARCH_BANDI" />">
						<wp:i18n key="LABEL_BANDI" />
					</a>
					&nbsp;
					<a href="<wp:action path="/ExtStr2/do/FrontEnd/Avvisi/openSearch.action" />" title="<wp:i18n key="LABEL_GO_TO_SEARCH_AVVISI" />">
			...
			<div class="fieldset-row">
				...
				<div class="element">
					...
					<s:select name="model.tipoAppalto" id="model.tipoAppalto" list="maps['tipiAppalto']" value="%{#searchForm.tipoAppalto}"
										headerKey="" headerValue="%{#attr.headerValueTipoAppalto}" autocomplete="off" ></s:select>
				</div>
			</div>
			...
			<div class="fieldset-row">
				...
				<div class="element">
					...
					<s:textfield name="model.dataPubblicazioneDa" id="model.dataPubblicazioneDa" cssClass="text" 
											 value="%{#searchForm.dataPubblicazioneDa}" maxlength="10" size="10" autocomplete="off" />
					...
					<s:textfield name="model.dataPubblicazioneA" id="model.dataPubblicazioneA" cssClass="text" 
											 value="%{#searchForm.dataPubblicazioneA}" maxlength="10" size="10" autocomplete="off" />
			...
			<div class="fieldset-row ">
				...
				<div class="element">
					<s:select name="model.sommaUrgenza" id="model.sommaUrgenza" list="maps['sino']" 
										value="%{#searchForm.sommaUrgenza}" headerKey="" headerValue="" autocomplete="off" >
					</s:select>
				</div>
			</div>
