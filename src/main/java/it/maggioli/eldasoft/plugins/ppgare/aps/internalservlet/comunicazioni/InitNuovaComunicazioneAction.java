		...
		if (null != this.getCurrentUser()
			...
			try {
				...
				if (this.customConfigManager.isVisible("COMUNICAZIONI", "INVIARISPONDI")) {
					...
					boolean contrattoLFS = (this.namespace != null && this.namespace.contains("ContrattiLFS"));
					...
					if(continua) {
						...
						helper.setComunicazioneApplicativo(this.applicativo);
						...
						if(entita != null && helper != null && helper.getEntita() == null){
						...
						if(stipula) {
							...
							StipulaContrattoType dettStipula = this.stipuleManager.dettaglioStipulacontratto(
									this.codice, 
									this.getCurrentUser().getUsername(), 
									true);
							if(dettStipula != null) {
