...
public interface PortGareSystemConstants {
    ...
    /**
     * Nome del bean proxy del servizio per scaricare i documenti digitali
     */
    public static final String DOCUMENTI_DIGITALI_MANAGER = "DocumentiDigitaliManager";
    ...
    /**
     * Identificativo dell'attributo in sessione contenente i dati del form di
     * ricerca stipule di contratti.
     */
    public static final String SESSION_ID_SEARCH_STIPULE = "formSearchStipuleContratto";
    
    /**
     * Identificativo dell'attributo in sessione contenente i dati del form di
     * ricerca di contratti LFS.
     */
    public static final String SESSION_ID_SEARCH_CONTRATTI_LFS = "formSearchContrattiLFS";
...
//    public static final String RICHIESTA_TIPO_BUSTA_ECONOMICA_OFFERTA_TELEMATICA = "FS11C";
    ...
    /**
     * Tipo di comunicazione per la richiesta di rinuncia di partecipazione ad una gara.
     */
     ...
     * Tipo di comunicazione per la richiesta di registrazione al portale.
     */
    public static final String RICHIESTA_ISCRIZIONE_ALBO_FORNITORI = "FS15";
    ...
    /**
     * Nome modello excel per aggiornamento prezzi unitari
     */
    public static final String NOME_MODELLO_EXCEL_VARIAZIONE_PREZZI_UNITARI = "variazione_prezzi_unitari";

    /**
     * Nome modello excel per aggiornamento prezzi unitari
     */
    public static final String NOME_MODELLO_EXCEL_VARIAZIONE_PREZZI_UNITARI_SEMPLICE = "variazione_prezzi_unitari_semplice";
    /**
     * Nome modello excel per aggiornamento prezzi unitari
     */
    public static final String NOME_MODELLO_EXCEL_VARIAZIONE_PREZZI_UNITARI_RIBASSO = "variazione_prezzi_unitari_ribasso";
    /**
     * Nome modello excel per aggiornamento prezzi unitari
     */
    public static final String NOME_MODELLO_EXCEL_VARIAZIONE_PREZZI_UNITARI_RICERCA_MERCATO = "variazione_prezzi_unitari_ricerca_mercato";
    ...
    /**
     * Percorso modello excel per aggiornamento prezzi unitari
     */
    public static final String MODELLO_EXCEL_VARIAZIONE_PREZZI_UNITARI_SEMPLICE = GARE_SHEET_FOLDER
            + "/" + NOME_MODELLO_EXCEL_VARIAZIONE_PREZZI_UNITARI_SEMPLICE + ".xls";
    /**
     * Percorso modello excel per aggiornamento prezzi unitari
     */
    public static final String MODELLO_EXCEL_VARIAZIONE_PREZZI_UNITARI_RIBASSO = GARE_SHEET_FOLDER
            + "/" + NOME_MODELLO_EXCEL_VARIAZIONE_PREZZI_UNITARI_RIBASSO + ".xls";
    /**
     * Percorso modello excel per aggiornamento prezzi unitari
     */
    public static final String MODELLO_EXCEL_VARIAZIONE_PREZZI_UNITARI_RICERCA_MERCATO = GARE_SHEET_FOLDER
            + "/" + NOME_MODELLO_EXCEL_VARIAZIONE_PREZZI_UNITARI_RICERCA_MERCATO + ".xls";
     ...
     * field per la messa in sessione dell'identificativo del file per la impresa
     */
    public static final String SESSION_ID_NSO_FILE_SDI = "nsoFileSdi";
    public static final String SESSION_ID_NSO_FILENAME_SDI = "nsoFileSdiName";
    public static final String SESSION_ID_NSO_SDI_PROG_INVIO = "progInvio";
	...
	public static final String TIPO_PROTOCOLLO_SSO_COHESION = "auth.sso.cohesion";
	public static final String TIPO_PROTOCOLLO_SSO_SPID = "auth.sso.spid";

	
	public static final String FILENAME_RIEPILOGO_BUSTE = "Riepilogo_buste.pdf";
	public static final String FILENAME_RIEPILOGO_BUSTE_MARCATURA_TEMPORALE = "Riepilogo_buste.pdf.tsd";
