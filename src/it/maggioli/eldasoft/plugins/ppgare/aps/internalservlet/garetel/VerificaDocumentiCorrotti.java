...
public class VerificaDocumentiCorrotti {
	...
	private RiepilogoBusteHelper riepilogo;
	 ...
	 * costruttore 
	 */
	public VerificaDocumentiCorrotti(RiepilogoBusteHelper riepilogo, IBandiManager bandiManager) {		
	...
	public void addMancante(String codGara, String codLotto, String tipoBusta, DocumentoAllegatoBean allegato) {			
		...
		if(StringUtils.isNotEmpty(codLotto) && riepilogo.getListaCodiciInterniLotti() != null) {
			lotto.setCodiceLotto(codLotto);
			lotto.setCodiceInterno( riepilogo.getListaCodiciInterniLotti().get(codLotto) );
		} 
