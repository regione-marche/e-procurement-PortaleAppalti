...
<div class="portgare-view">
	...
	<jsp:include page="/WEB-INF/plugins/ppcommon/aps/jsp/balloon_info.jsp">
			<jsp:param name="keyMsg" value="BALLOON_AGG_IMPRESA_INDIRIZZI_IMPRESA"/>
	</jsp:include>

	<form action="<wp:action path="/ExtStr2/do/FrontEnd/DatiImpr/processPageIndirizziImpresa.action" />" method="post">
