...
<h4><s:text name="label.edit" />: <span class="monospace"><s:property value="#attributeElement.name" /></span> (<span class="monospace"><s:property value="#attributeElement.type" /></span>)</h4>
...
<p class="noscreen">
	<wpsf:hidden name="attributeName" ></wpsf:hidden>
	<wpsf:hidden name="attributeTypeCode" ></wpsf:hidden>
	<wpsf:hidden name="strutsAction" ></wpsf:hidden>
</p>
...
<fieldset><legend><s:text name="label.info" /></legend>
	...
	<s:if test="isEntityManagerSearchEngineUser()">
	<p>
...
<s:if test="#attributeElement.type == 'Enumerator'">
...
<s:elseif test="#attributeElement.textAttribute">
<fieldset><legend><s:text name="label.settings" /></legend>
	<p>
