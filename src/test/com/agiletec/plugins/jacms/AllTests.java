...
import test.com.agiletec.plugins.jacms.aps.system.services.content.showlet.TestAdvancedContentListHelper;
...
public class AllTests {
	...
	public static Test suite() {
		...
		suite.addTestSuite(TestAdvancedContentListHelper.class);
