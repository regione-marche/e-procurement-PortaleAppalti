...
<s:if test="%{#elencoComunicazioniRiservate.length > 0}">
	<ul class="list-comunicazioni">
		<s:iterator value="#elencoComunicazioniRiservate" var="comunicazione" status="statCom">
			<s:set var="numeroComunicazioniRiservate" value="%{#numeroComunicazioniRiservate + 1}" />
