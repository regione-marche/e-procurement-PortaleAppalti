<%-- 
  QUESTA JSP SOSTITUISCE ED INTEGRA IL VECCHIO static/js/ppgare/uploadFileCatalogo.js
...
<script type="text/javascript" src='<wp:resourceURL/>static/js/ppgare/uploadFileCatalogo.js'></script>
