...
public class EntityTypeConfigAction extends AbstractEntityConfigAction implements IEntityTypeConfigAction {
	...
	public void validate() {
		...
		if (this.getOperationId() == ApsAdminSystemConstants.ADD && !this.hasFieldErrors()) {
			if (null != this.getEntityPrototype(entityType.getTypeCode())) {
				...
				this.addFieldError("entityTypeCode", this.getText("field.error.entity.alredy.exists", args));
			}
		}
	}
	...
	public String editEntityType() {
		try {
			...
			if (null == entityType) {
				...
				this.addFieldError("entityTypeCode", this.getText("field.error.entity.type.null",args));
				return INPUT;
			}
	...
	private String checkEntityManager() {
		try {
			...
			this.addFieldError("entityManagerName", this.getText("field.error.entityManager.invalid", args));
	...
	public String addAttribute() {
		...
		try {
			...
			if (null == attributeTypes.get(this.getAttributeTypeCode())) {
				...
				this.addFieldError("attributeTypeCode", this.getText("field.error.attribute.not.exists",args));
				return INPUT;
			}
		} catch (Throwable t) {
	...
	public String editAttribute() {
		try {
			...
			if (null == entityType.getAttribute(this.getAttributeName())) {
				...
				this.addFieldError("attributeName", this.getText("field.error.attribute.not.exists", args));
				return INPUT;
			}
		} catch (Throwable t) {
