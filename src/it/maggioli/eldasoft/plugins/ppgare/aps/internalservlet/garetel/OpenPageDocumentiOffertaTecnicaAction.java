	...
	public String openPage() {
		...
		try {
			...
			if (wizardPartecipazione.isPlicoUnicoOfferteDistinte()) {
				...
				if(!bustaRiepilogativa.getPrimoAccessoTecnicheEffettuato().get(helper.getCodice())) {
					bustaRiepilogativa.getPrimoAccessoTecnicheEffettuato().put(helper.getCodice(), true);
					...
					bustaRiepilogativa.sendComunicazioneBusta(
							...
							(String)this.session.get("codiceGara"),  // o this.codice ??? 
