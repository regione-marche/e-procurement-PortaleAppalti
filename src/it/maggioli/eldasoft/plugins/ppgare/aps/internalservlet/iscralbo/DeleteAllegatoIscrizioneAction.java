		...
		if (iscrizioneHelper == null) {
			...
			try {
				...
				evento.setMessage(this.getFunzione(iscrizioneHelper)
						...
						+ documentiHelper.getDocRichiestiFileName().get(this.id)
						+ ", dimensione=" + documentiHelper.getDocRichiestiSize().get(this.id) + "KB");
		...
		if (iscrizioneHelper == null) {
			...
			try {
				...
				evento.setMessage(this.getFunzione(iscrizioneHelper)
						...
						+ documentiHelper.getDocUlterioriFileName().get(this.id)
						+ ", dimensione=" + documentiHelper.getDocUlterioriSize().get(this.id) + "KB");
