...
<s:set var="bustaPartecipazione" value="%{#session.dettaglioOffertaGara.bustaPartecipazione}"/>
...
<%-- OBSOLETO
	<jsp:include page="/WEB-INF/plugins/ppgare/aps/jsp/internalServlet/datiimpresa/datiRiepilogoSection.jsp">
		<jsp:param name="sessionIdObj" value="dettPartecipGara" />  <== NON SERVE PIU', GESTITO DALLA datiRiepilogoSection.jsp !!!
	</jsp:include>
--%>
	<jsp:include page="/WEB-INF/plugins/ppgare/aps/jsp/internalServlet/datiimpresa/datiRiepilogoSection.jsp" />
