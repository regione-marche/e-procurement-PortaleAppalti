...
public interface IAuthenticationProviderManager {
	...
	/**
	 *  Restituisce l'elenco degli utenti presenti su db
	 */
	 ...
	 * @param sessionId Il session ID da cui e' stato effettuato il tentativo.
	 * @throws ApsSystemException In caso di errore.
	 */
	public void logWrongAccess(UserDetails user, String username, String ipAddress, String sessionId, String currentLang) throws ApsSystemException;
