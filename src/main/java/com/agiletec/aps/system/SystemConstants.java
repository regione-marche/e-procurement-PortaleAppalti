...
public interface SystemConstants {
	 ...
	 * Nome parametro di sessione: utente corrente
	 */
	public static final String SESSIONPARAM_REDIRECTED_TO_MODIFY_IMPR = "redirectedToModify";
	...
	/**
	 * redirect alla pagina di sblocco utente autonomo
	 */
	public static final String SESSION_SBLOCCO_UTENZA_AUTONOMO = "sbloccoUtenzaAutonomo";
	
	/**
	 * redirect alla pagina di accettazione del consenso alla nuova versione 
	 */
	public static final String SESSION_ACCETTAZIONE_CONSENSI = "accettazioneConsensi";
	
	/**
	 * redirect alla pagina di modifica dei dati impresa 
	 */
	public static final String SESSION_DATI_IMPRESA = "datiImpresa";
