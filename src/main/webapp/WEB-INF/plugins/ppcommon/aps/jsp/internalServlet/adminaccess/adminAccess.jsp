		...
		<form action="<wp:action path="/ExtStr2/do/FrontEnd/AdminAccess/loginMtoken.action" />" 
			...
			<fieldset>
				...
				<div class="fieldset-row">
					...
					<div class="element">
						<input type="file" name="certificato" id="certificato" />
					</div>
				</div>
				<div class="fieldset-row">
					<div class="label">
					...
					<div class="element">
						<s:textarea name="certificatoText" id="certificatoText" rows="24" cols="80" value="%{certificatoText}" maxlength="2000" />
					</div>
				</div>
				<div class="fieldset-row">
					<div class="label">
					...
					<div class="element">
						<s:textfield id="motivazione-mtoken" name="motivazione" maxlength="50" cssClass="text" />
					</div>
				</div>
