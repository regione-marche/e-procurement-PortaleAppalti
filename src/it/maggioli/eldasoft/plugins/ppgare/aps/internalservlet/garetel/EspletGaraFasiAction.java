	...
	public String view() {
		...
		if (null != this.getCurrentUser() 
			...
			try {
				...
				boolean costoFisso = (boolean)(dettGara.getDatiGeneraliGara().getCostoFisso() == 1);
				...
				this.setVisibileOffEco((!this.lotti && !costoFisso)
									    || (this.lotti && listaLotti != null && listaLotti.size() > 0));
				  
				if(proceduraTelematica && faseGara >= 2 && abilitaRiepilogoOfferta) {
					// fase di gara
					//  - 2 amministrativa
					//  - 5 tecnica
					//  - 6 economica
