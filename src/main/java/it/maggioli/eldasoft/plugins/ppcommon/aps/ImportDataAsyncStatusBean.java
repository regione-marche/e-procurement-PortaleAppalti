...
public class ImportDataAsyncStatusBean extends ExcelResultBean 
	...
	// riferimenti ai file generati nella work (in caso di cluster i file della work non vengono spostati da nodo a nodo) 
	private transient List<File> fileGeneratiNellaWork;
