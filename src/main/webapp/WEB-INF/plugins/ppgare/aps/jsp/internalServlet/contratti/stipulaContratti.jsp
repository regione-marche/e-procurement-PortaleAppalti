			...
			<s:iterator id="stipula" value="stipule">
				<div class = "list-item">
					...
					<div class="list-action">
						<a href='<wp:action path="/ExtStr2/do/FrontEnd/Contratti/dettaglioStipulaContratti.action" />&amp;id=<s:property value="id"/>&amp;codice=<s:property value="codiceStipula"/>&amp;&amp;${tokenHrefParams}' 
