...
public class GroupAction extends BaseAction implements IGroupAction {
	...
	public void validate() {
		...
		if (this.getStrutsAction() == ApsAdminSystemConstants.ADD) {
			...
			this.addActionError("MESSAGGIO_GRUPPO_NON_ESISTENTE");
		}
	}
	...
	protected void checkDuplicatedGroup() {
		if (this.existsGroup()) {
			...
			//	TODO Label da revisionare
			this.addFieldError("name", this.getText("MESSAGGIO_AGGIUNTA_GRUPPO_ESISTENTE", args));
		}
	}
	...
	public String edit() {
		...
		try {
			if (!this.existsGroup()) {
				//	TODO Label da revisionare
				this.addActionError(this.getText("MESSAGGIO_GRUPPO_NON_ESISTENTE"));
				return "groupList";
			}
	...
	protected boolean checkGroupForDelete() throws ApsSystemException {
		...
		if (Group.FREE_GROUP_NAME.equals(name) || Group.ADMINS_GROUP_NAME.equals(name)) {
			//	TODO Label da revisionare
			this.addActionError(this.getText("MESSAGGIO_GRUPPO_NON_ELIMINABILE"));
			return false;
		}
		return true;
	}
