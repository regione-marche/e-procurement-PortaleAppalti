...
<div class="portgare-view">
	...
	<h2><wp:i18n key="TITLE_PAGE_DETTAGLIO_BANDO_ISCRIZIONE" /></h2>

	<jsp:include page="/WEB-INF/plugins/ppcommon/aps/jsp/balloon_info.jsp">
		<jsp:param name="keyMsg" value="BALLOON_CATEGORIE_DETTAGLIO_BANDO_ISCRIZIONE"/>
	</jsp:include>
	...
	<form action="<wp:action path="/ExtStr2/do/FrontEnd/Bandi/viewCategorieIscrizione.action" />" method="post">
	...
	<div class="back-link">
		<a href="<wp:action path="/ExtStr2/do/FrontEnd/Bandi/viewIscrizione.action" />&amp;codice=${param.codice}&amp;ext=${param.ext}">
