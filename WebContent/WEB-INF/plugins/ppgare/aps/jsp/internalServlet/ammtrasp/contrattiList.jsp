			...
			<s:if test="%{listaContratti.size() > 0}">
				...
				<div class="list-summary">
	 			...
	 			<div class="table-container">
					<table id="tableBandi" summary="Tabella Singole Procedure" class="info-table source-popup">
						<thead>
							<tr>
						...
						<tbody>
							<s:iterator var="riga" value="listaContratti">
								<tr>									
									...
									<td><s:if test="%{strutturaProponenteCF != null}"><s:property value="strutturaProponenteCF" /> - </s:if><s:property value="strutturaProponenteDenominazione" /></td>
