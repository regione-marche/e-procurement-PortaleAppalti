...
public class TestContentDAO extends BaseTestCase {
	...
	public void testGetGroupUtilizers() throws Throwable {
		...
		assertNotNull(contentIds);
		assertEquals(4, contentIds.size());
		String contentId = contentIds.get(0);
		assertEquals("ART102", contentId);
		contentId = contentIds.get(1);
		assertEquals("ART111", contentId);
		contentId = contentIds.get(2);
		assertEquals("ART122", contentId);
		contentId = contentIds.get(3);
		assertEquals("RAH101", contentId);
    }
