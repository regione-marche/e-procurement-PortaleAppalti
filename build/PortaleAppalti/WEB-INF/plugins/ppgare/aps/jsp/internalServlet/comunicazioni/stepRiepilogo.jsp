...
<div class="portgare-view">
	...
	<div class="azioni">
		...
		<%-- 
		<form action="<wp:action path="/ExtStr2/do/FrontEnd/Comunicazioni/sendNuovaComunicazione.action" />" method="post" class="azione">
			<jsp:include page="/WEB-INF/plugins/ppcommon/aps/jsp/token_input.jsp" />
			<div>
				<s:submit value="Invia comunicazione" title="Invia la comunicazione"  cssClass="button" method="send"></s:submit>
			</div>
		</form>
		--%>
	</div>
