...
public class BandiFinderAction extends EncodedDataAction implements
	...
	private String getListaBandi(String fromPage) {
		...
		Boolean proceduraTelematica = null;
		if (StringUtils.isNotEmpty(this.model.getProceduraTelematica())) {
			proceduraTelematica = "1".equals(model.getProceduraTelematica());
		}
		
		if(!"3".equals(this.model.getStato()) ) {
			// solo se la gara e' conclusa (3=Conclusa) c'e' esito... 
			this.model.setEsito(null);
		}
...
//		}
		...
		if(fromPage.equalsIgnoreCase(LIST_ALL_VEND_SCADUTI) ||
		   ...
		   fromPage.equalsIgnoreCase(LIST_ALL_VEND_IN_CORSO)) {
			garaPrivatistica = new Integer(1); 
	       ...
	       fromPage.equalsIgnoreCase(LIST_ALL_ACQ_IN_CORSO)) {
			garaPrivatistica = new Integer(2); 
		}
		...
		if (SUCCESS.equals(this.getTarget()) && dateOk) {
			...
			try {	
				...
				if(fromPage.equalsIgnoreCase(LIST_ALL_IN_CORSO)) {
					this.listaBandi = this.bandiManager
						.getElencoBandi(
								this.model.getStazioneAppaltante(),
								this.model.getOggetto(), 
								this.model.getCig(),
								this.model.getTipoAppalto(), 
				...
				if(fromPage.equalsIgnoreCase(LIST_ALL_RICHIESTE_OFFERTA)) {
					this.listaBandi = this.bandiManager
				...
				if(fromPage.equalsIgnoreCase(LIST_ALL_RICHIESTE_DOCUMENTI)) {
					this.listaBandi = this.bandiManager
				...
				if(fromPage.equalsIgnoreCase(LIST_ALL_ASTE_IN_CORSO)) {
	    			this.listaBandi = this.bandiManager
				...
				if(fromPage.equalsIgnoreCase(SEARCH_PROCEDURE)) {
					this.listaBandi = this.bandiManager
				...
				if(fromPage.equalsIgnoreCase(SEARCH_BANDI_CON_ESITO)) {
					this.listaBandi = this.bandiManager
						.searchBandiConEsito(
								this.model.getStazioneAppaltante(),
								this.model.getOggetto(),
				...
				if(fromPage.equalsIgnoreCase(LIST_ALL_ACQ_SCADUTI)) {
					this.listaBandi = this.bandiManager
						.getElencoBandiScadutiPrivatistiche(
								this.model.getStazioneAppaltante(),
								this.model.getOggetto(), 
								this.model.getCig(),
								this.model.getTipoAppalto(), 
				...
				if(fromPage.equalsIgnoreCase(LIST_ALL_ACQ_RICHIESTE_OFFERTA)) {
					this.listaBandi = this.bandiManager
						.getElencoBandiPerRichiesteOffertaPrivatistiche(
								this.getCurrentUser().getUsername(),
								this.model.getStazioneAppaltante(),
								this.model.getOggetto(), 
								this.model.getCig(),
				...
				if(fromPage.equalsIgnoreCase(SEARCH_PROCEDURE_ACQ)) {
					this.listaBandi = this.bandiManager
						.searchBandiPerProcInAggiudicazionePrivatistiche(
								this.getCurrentUser().getUsername(),
								this.model.getStazioneAppaltante(),
								this.model.getOggetto(), 
								this.model.getCig(),
				...
				if(fromPage.equalsIgnoreCase(LIST_ALL_ACQ_IN_CORSO)) {
					this.listaBandi = this.bandiManager
						.getElencoBandiPrivatistiche(
								this.model.getStazioneAppaltante(),
								this.model.getOggetto(), 
								this.model.getCig(),
								this.model.getTipoAppalto(), 
				...
				if(fromPage.equalsIgnoreCase(LIST_ALL_VEND_RICHIESTE_OFFERTA)) {
					this.listaBandi = this.bandiManager
						.getElencoBandiPerRichiesteOffertaPrivatistiche(
								this.getCurrentUser().getUsername(),
								this.model.getStazioneAppaltante(),
				...
				if(fromPage.equalsIgnoreCase(SEARCH_PROCEDURE_VEND)) {
					this.listaBandi = this.bandiManager
						.searchBandiPerProcInAggiudicazionePrivatistiche(
								this.getCurrentUser().getUsername(),
								this.model.getStazioneAppaltante(),
				...
				if(fromPage.equalsIgnoreCase(LIST_ALL_VEND_IN_CORSO)) {
					this.listaBandi = this.bandiManager
						.getElencoBandiPrivatistiche(
								this.model.getStazioneAppaltante(),
								this.model.getOggetto(), 
