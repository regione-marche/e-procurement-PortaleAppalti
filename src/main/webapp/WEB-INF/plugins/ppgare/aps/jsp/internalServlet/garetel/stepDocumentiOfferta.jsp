...
<s:set var="codiceTitolo" value="%{#bustaEconomica.codiceGara}" />
<s:set var="documentiRichiesti" value="%{#session['dettaglioOffertaGara'].bustaEconomica.documentiRichiestiDB}" />
