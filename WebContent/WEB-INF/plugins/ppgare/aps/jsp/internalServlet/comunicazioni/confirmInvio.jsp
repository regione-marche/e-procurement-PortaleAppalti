...
<s:if test="%{from == 'rispondi'}">
	...
	<!--
	<c:set var="pathProcedura" value="/ExtStr2/do/FrontEnd/Comunicazioni/openPageDettaglioSoccorsoIstruttorio.action"/>
	-->
</s:if>
<s:else>
	<s:if test="%{genere == 10}">
...
<div class="portgare-view">
	...
	<div class="azioni">
		<form action='<wp:action path="${pathProcedura}" />&amp;codice=<s:property value="%{codice}"/>&amp;idComunicazione=<s:property value="%{idComunicazione}"/>&amp;idDestinatario=<s:property value="%{idDestinatario}"/>'
