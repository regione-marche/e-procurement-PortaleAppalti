...
<div class="portgare-view">
	...
	<h2><wp:i18n key="TITLE_PAGE_DETTAGLIO_AVVISO_COMUNICAZIONE_ATTO" /></h2>

	<jsp:include page="/WEB-INF/plugins/ppcommon/aps/jsp/balloon_info.jsp">
		<jsp:param name="keyMsg" value="BALLOON_DETTAGLIO_AVVISO_COMUNICAZIONE_ATTO"/>
	</jsp:include>
	...
	<div class="detail-section">
		...
		<div class="detail-row">
			...
			<s:iterator value="maps['tipiAvvisoGenerali']">
				<s:if test="%{key == dettaglioAvviso.datiGenerali.tipoAvvisoGenerale}"><s:property value="%{value}"/></s:if>
			</s:iterator>
		</div>
		...
		<div class="detail-row">
			<ul class="list">
				<li class='first last'>
					<a href="<wp:action path="/ExtStr2/do/FrontEnd/Avvisi/viewAltriDocumentiAvvisiComunicazioniAtti.action"/>&amp;codice=${codice}&amp;ext=${param.ext}"
					   class="bkg-big go" title='<wp:i18n key="LABEL_ALTRI_DOCUMENTI" />' >
...
--%>
	...
	<c:if test="${sessionScope.fromPage != null && sessionScope.fromPageOwner eq 'avvisiComunicazioniAtti'}">
