...
import { PROVINCE } from './lista-province.js'

export function normalizeString (str) {
  return str.trim()
    .replace(new RegExp(/[àáÀÁ]/g), 'a\'')
    .replace(new RegExp(/[èéÈÉ]/g), 'e\'')
    .replace(new RegExp(/[ìíÌÍ]/g), 'i\'')
    .replace(new RegExp(/[òóÒÓ]/g), 'o\'')
    .replace(new RegExp(/[ùúÙÚ]/g), 'u\'')
    .toUpperCase()
}
