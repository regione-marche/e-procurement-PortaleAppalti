 ...
 */
public class AvvisiAction extends EncodedDataAction implements SessionAware {
	/**
	 * UID
	 */
	...
	public String view() {
		...
		try {
			...
			StatisticheComunicazioniPersonaliType stat = this.bandiManager
				.getStatisticheComunicazioniPersonali(this.getCurrentUser().getUsername(), this.codice);			
