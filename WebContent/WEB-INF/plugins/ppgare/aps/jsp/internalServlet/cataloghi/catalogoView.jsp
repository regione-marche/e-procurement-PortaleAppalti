...
<script type="text/javascript" src='<wp:resourceURL/>static/js/ppgare/viewComunicazioni.js'></script>
...
<div class="portgare-view">
	...
	<h2><wp:i18n key="TITLE_PAGE_DETTAGLIO_CATALOGO" /></h2>

	<jsp:include page="/WEB-INF/plugins/ppcommon/aps/jsp/balloon_info.jsp">
		<jsp:param name="keyMsg" value="BALLOON_DETTAGLIO_CATALOGO"/>
	</jsp:include>
	...
	<div class="back-link">
		<c:choose>
			...
			<c:when test="${empty param.ext}">
				<a href='<wp:action path="/ExtStr2/do/FrontEnd/Cataloghi/listAllCataloghi.action" />&amp;${tokenHrefParams}'>
