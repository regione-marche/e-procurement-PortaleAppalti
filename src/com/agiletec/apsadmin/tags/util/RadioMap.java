...
public class RadioMap extends UIBean {
	...
	public RadioMap(ValueStack stack, HttpServletRequest request, HttpServletResponse response, String checked, String var, String tabindex) {
		...
		if (null != tabindex) this.setTabindex(tabindex);
	}
	...
	protected void evaluateExtraParams() {
		...
		if (null == this.getChecked()) {
			...
			if (rtValue.toString().equals(this.getVar())) {				
