...
<c:set var="fromPageFirmaDigitale" scope="session"><wp:action path="/ExtStr2/do/FrontEnd/GareTel/openPageOffTelDocumenti.action"/></c:set>

<s:set var="helper" value="%{#session['offertaEconomica']}" />
<s:set var="documenti" value="%{#helper.documenti}" />

<%-- verifica la presenza di documenti senza firma, quindi non verificabili --%>
...
<div class="portgare-view">
	...
	<jsp:include page="/WEB-INF/plugins/ppcommon/aps/jsp/balloon_info.jsp">
		<jsp:param name="keyMsg" value="BALLOON_WIZ_DOCUMENTI_OFFERTA_OFFERTA_TEL"/>
	</jsp:include>
	...
	<s:if test="%{deleteDocRichiesto}">
		...
		<div class="azioni">
			<form action="<wp:action path="/ExtStr2/do/FrontEnd/GareTel/deleteOffertaAllegatoRichiesto.action" />" method="post" class="azione">
			...
			<form action="<wp:action path="/ExtStr2/do/FrontEnd/GareTel/cancelDeleteOffertaAllegatoRichiesto.action" />" method="post" class="azione">
				<jsp:include page="/WEB-INF/plugins/ppcommon/aps/jsp/token_input.jsp" />
	...
	<s:elseif test="%{deleteDocUlteriore}">
		...
		<div class="azioni">
			<form action="<wp:action path="/ExtStr2/do/FrontEnd/GareTel/deleteOffertaAllegatoUlteriore.action" />" method="post" class="azione">
				<jsp:include page="/WEB-INF/plugins/ppcommon/aps/jsp/token_input.jsp" />
			...
			<form action="<wp:action path="/ExtStr2/do/FrontEnd/GareTel/cancelDeleteOffertaAllegatoUlteriore.action" />" method="post" class="azione">
				<jsp:include page="/WEB-INF/plugins/ppcommon/aps/jsp/token_input.jsp" />
	...
	<s:else>
		...
		<fieldset>
			...
			<div class="table-container">
				<table id="tableDocumenti" class="wizard-table" summary="</span><wp:i18n key='LABEL_ELENCO_DOCUMENTI' />">
					<thead>
						<tr>
					...
					<tbody>
						<!-- DOCUMENTI RICHIESTI -->
						<s:if test="%{documentiRichiesti.size() > 0}">
							<s:url id="urlDownloadDocRichiesto" namespace="/do/FrontEnd/GareTel" action="downloadOffertaAllegatoRichiesto" />
								...
								<tr>
									...
									<td class="azioni">
										<ul>
											...
											<s:if test="%{!#caricato}">
												<li>
													<form action="<wp:action path="/ExtStr2/do/FrontEnd/GareTel/processPageOffTelDocumenti.action" />" method="post" 
														...
														<div>
															...
															<label class="noscreen" for="docRichiesto"><wp:i18n key='LABEL_FILE'/> : </label>
																<input type="file" name="docRichiesto" id="docRichiesto" size="20" cssClass="block-ui"
																	aria-label="${nome}" 
						...
						<!-- DOCUMENTI ULTERIORI -->
						<s:url id="urlDownloadDocUlteriore" namespace="/do/FrontEnd/GareTel" action="downloadOffertaAllegatoUlteriore" />
