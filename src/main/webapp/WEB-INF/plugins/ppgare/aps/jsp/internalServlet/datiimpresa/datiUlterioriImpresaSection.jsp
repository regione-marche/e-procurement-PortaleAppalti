...
<es:checkCustomization var="obblSettoreAttivitaEconomica" objectId="IMPRESA-DATIULT-CCIAA" attribute="SETTOREATTIVITA" feature="MAN" />
				...
				<div class="element">
					...
					<div class="contents-group">
						...
						<s:textfield name="localitaIscrizioneCassaEdile" id="localitaIscrizioneCassaEdile" value="%{localitaIscrizioneCassaEdile}"
												 size="100" maxlength="100" aria-label="${lblLocIscrCassaEdile}"/>
					</div>
				</div>
			</div>
				...
				<div class="element">
					...
					<div class="contents-group">
						...
						<s:textfield name="localitaIscrizioneINAIL" id="localitaIscrizioneINAIL" value="%{localitaIscrizioneINAIL}"
												 size="100" maxlength="100" aria-label="${lblLocIscrINAIL}"/>
					</div>
				</div>
			</div>
		</c:if>
...
<input type="hidden" name="obbIban" value="${obbIban}" />
...
<!--//--><![CDATA[//><!--
	...
	$("select[id^='iscrittoCCIAA']").change(function() {
		...
		// societ? di professionisti (TIPIMP.IMPR <= 5) impostare ISCRCCIAA a "No"
