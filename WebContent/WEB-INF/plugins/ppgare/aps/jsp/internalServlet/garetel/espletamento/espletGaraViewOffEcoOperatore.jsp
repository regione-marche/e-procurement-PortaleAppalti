...
<div class="portgare-view">
	...
	<s:if test="%{operatoreEconomico.codiceModAgg == 17}" >
	 	<div class="fieldset-row">
			<div class="label">
 	...
 	<s:elseif test="%{operatoreEconomico.codiceModAgg != 6 &&
	...
	<s:elseif test="%{operatoreEconomico.codiceModAgg != 6 && operatoreEconomico.tipoRibasso == 1}">
		 	<div class="fieldset-row">
			<div class="label">
			...
			<div class="element">
				<s:if test="%{#ribassoRialzo != null && #ribassoRialzo != 0}" >
					<s:text name="format.money5dec"><s:param value="-1 * operatoreEconomico.ribassoOfferto"/></s:text>
				</s:if>
			</div>
	 	</div>
	</s:elseif> 
	<s:elseif test="%{operatoreEconomico.codiceModAgg == 6}">
	 	...
	 	<s:if test="%{operatoreEconomico.riparametrazioneEconomica == 1 || 
