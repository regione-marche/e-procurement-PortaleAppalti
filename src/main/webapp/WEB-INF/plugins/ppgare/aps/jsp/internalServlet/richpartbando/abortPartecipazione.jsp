...
<div class="portgare-view">
	...
	<h2><wp:i18n key='TITLE_PAGE_RICHPART_ANNULLA_PARTECIPAZIONE'/></h2>

	<p><wp:i18n key='LABEL_RICHPART_ANNULLA_PARTECIPAZIONE_1'/></p>
	<p><wp:i18n key='LABEL_RICHPART_ANNULLA_PARTECIPAZIONE_2'/></p>
	...
	<div class="azioni">
		...
		<c:choose>
			<c:when test="${(sessionScope.page eq 'impr') || (sessionScope.page eq 'impresa')}">
		...
		<form action="<wp:action path="${href}" />" method="post" class="azione">
			...
			<div>
				<wp:i18n key='BUTTON_WIZARD_BACK_TO_PARTECIPAZIONE' var='valueButtonBackTo' />
