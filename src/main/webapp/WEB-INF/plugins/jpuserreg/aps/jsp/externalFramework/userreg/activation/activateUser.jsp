...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		var validator = $("#activate_user_form").validate({
			rules: {
				password: {
					required: true,
...
<div class="portgare-view">
	...
	<h2><wp:i18n key="jpuserreg_ACTIVATION"/></h2>

	<jsp:include page="/WEB-INF/plugins/ppcommon/aps/jsp/balloon_info.jsp">
		<jsp:param name="keyMsg" value="BALLOON_jpuserreg_ACTIVATION"/>
	</jsp:include>

	<form id="activate_user_form" class="change_password_form" action="<wp:action path="/ExtStr2/do/jpuserreg/UserReg/activate.action" />" method="post">
		...
		<table>
			<tr>
				...
				<td class="field"><s:password name="password"  autocomplete="off" id="jpuserreg_password" maxlength="50" cssClass="text" value="" /></td>
				<td class="status">
			...
			<tr>
				...
				<td class="field"><s:password autocomplete="off" name="passwordConfirm" id="jpuserreg_passwordConfirm" maxlength="50" cssClass="text" value="" /></td>
				<td class="status"> </td>	
			</tr>
		</table>
