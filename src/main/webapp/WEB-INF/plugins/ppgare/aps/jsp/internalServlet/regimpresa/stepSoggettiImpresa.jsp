...
<div class="portgare-view">
	...
	<jsp:include page="/WEB-INF/plugins/ppcommon/aps/jsp/balloon_info.jsp">
		<jsp:param name="keyMsg" value="BALLOON_REG_IMPRESA_SOGGETTI_IMPRESA"/>
	</jsp:include>

	<form action="<wp:action path="/ExtStr2/do/FrontEnd/RegistrImpr/processPageSoggettiImpresa.action" />" method="post">
