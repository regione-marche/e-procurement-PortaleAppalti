...
//		Ragionarci
	...
	protected void sendAlertRegProfile(String userName, IUserProfile regProfile, String token) throws ApsSystemException {
		...
		String text = this.prepareBody(config.getActivationMailBody(langCode), params);
