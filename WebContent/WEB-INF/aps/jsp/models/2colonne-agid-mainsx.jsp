	...
	<head prefix="og: http://ogp.me/ns#; dcterms: http://purl.org/dc/terms/#">
		...
		<c:choose>
			...
			<c:otherwise>
				...
				<c:if test="${setCss eq '01' || setCss eq 'jcity-gov' || setCss eq 'appalti-contratti'}">
		...
		<c:if test="${setCss == 'appalti-contratti'}">
	
			<script type="text/javascript" src="<wp:resourceURL/>static/js/ScrollHeader.js"></script>
		</c:if>
				
		<script type="text/javascript" src="<wp:resourceURL/>static/js/jquery-3.4.1.min.js"></script>
		...
		<script type="text/javascript" src="<wp:resourceURL/>static/js/resizeBalloon.js"></script>
	</head>
		...
		<div class="viewport-container">
			<div id="ext-container" class="smooth-transition page-container">
				<jsp:include page="inc/header-agid.jsp">
					<jsp:param name="layoutPage" value="two-columns-right-menu" />
				</jsp:include>
				<div class="container two-columns-right-menu">
					<div class="columns">
						<div class="row">
							<main class="col-9">
				...
				<jsp:include page="inc/footer-agid.jsp" /><!-- end #ext-container -->
			</div>
