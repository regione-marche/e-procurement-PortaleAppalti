...
/**
 * Tag per l'esecuzione preliminare delle showlet.
 * Da usare esclusivamente nella main.jsp.
 * Non produce alcun output, bensì inserisce nel RequestContext gli output parziali
 * delle singole showlet e le informazioni da includere nella testata della pagina.
...
public class ExecShowletTag extends TagSupport {
	 ...
	 * @throws JspException In caso di errori occorsi 
	 * in questo metodo o in una delle jsp incluse.
	 */
