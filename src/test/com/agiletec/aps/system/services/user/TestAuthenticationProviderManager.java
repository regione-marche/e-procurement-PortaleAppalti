...
public class TestAuthenticationProviderManager extends BaseTestCase {
    ...
    private void togglePrivacyModuleStatus(boolean enable) throws Throwable {
    	try {
    		String originalParams = this._configurationManager.getConfigItem("params");
        	...
        	this._configurationManager.updateConfigItem("params", newXmlParams);
    	} catch (Throwable t) {
    		throw t;
    	}
    }
    ...
    private void init() throws Exception {
    	try {
    		...
    		this._authenticationProvider = (IAuthenticationProviderManager) this.getService("AuthenticationProviderManager"); 
