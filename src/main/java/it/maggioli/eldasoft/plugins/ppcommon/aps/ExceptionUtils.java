...
public class ExceptionUtils {
	...
	public static void manageWSDMExceptionError(Throwable e, ActionSupport action) {
		action.addActionError(action.getText("Errors.service.wsdmHandshake")); // + ": " + e.getMessage());
	}
