...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="it">
	...
	<head>
		...
		<script type="text/javascript" src="http://www.aryweb.nl/projects/mooModernizr/mooModernizr-min.js"></script>
		...
		<style type="text/css">
			...
			body.textshadow h1, body.textshadow a {
	...
	<body>
		<!-- START WELCOME -->
		<h1>It Worked!<br /> jAPS 2.0 - java Agile Portal System, is Installed on this Host.</h1>
		...
		<p>
			...
			If you can see this page, then the people who own this host have just installed jAPS 2.0 successfully.<br/>
		...
		<p>
		Have a good time with jAPS 2.0!<br />
		- The AgileTeam -
		</p>
		<h2>Links:</h2>
		<ul>
			<li><a href="http://www.japsportal.org">Home of the jAPS 2.0 project</a></li>
			<li><a href="http://sourceforge.net/projects/japs">jAPS 2.0 at SourceForge</a></li>
			<li><a href="http://dev.japsportal.org/">jAPS 2.0 dev-site with useful documentation</a></li>
			<li><a href="http://dev.japsportal.org/trac/wiki/DocumentationTechnicalBuildingAWebPortalHOWTO">Building a Web Portal with jAPS 2.0 - HOWTO</a></li>
		</ul>
	<!-- END WELCOME -->
	</body>
</html>
