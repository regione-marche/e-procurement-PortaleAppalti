...
public class OpenPageUtenzaAction extends BaseAction implements SessionAware {
	...
	public String openPage() {
		...
		if (registrazioneHelper == null) {
		    ...
		    this.ssoPresente = (sso != null);
	
			this.ssoProtocollo = (Integer)this.appParamManager.getConfigurationValue(PortGareSystemConstants.TIPO_PROTOCOLLO_SSO);
			if(this.ssoProtocollo == null) {
				this.ssoProtocollo = new Integer(PortGareSystemConstants.MIN_NUM_SSO_PROTOCOLLO);
			}
