...
public class OpenPageScaricaDomandaIscrizioneAction extends AbstractOpenPageAction {
	...
	public void setInputFirmatarioMandanteVisible(
			boolean inputFirmatarioMandanteVisible) {
	...
	public String openPageAfterErrorMandante() {
		...
		if(err.isEmpty() || !errFileds.isEmpty() || !err.toArray()[0].toString().equals(this.getText("Errors.offertaTelematica.scaricaPDF"))) {
