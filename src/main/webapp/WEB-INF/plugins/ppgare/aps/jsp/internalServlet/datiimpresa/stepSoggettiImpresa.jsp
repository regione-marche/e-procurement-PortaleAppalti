...
<div class="portgare-view">
	...
	<jsp:include page="/WEB-INF/plugins/ppcommon/aps/jsp/balloon_info.jsp">
			<jsp:param name="keyMsg" value="BALLOON_AGG_IMPRESA_SOGGETTI_IMPRESA"/>
	</jsp:include>

	<form action="<wp:action path='/ExtStr2/do/FrontEnd/DatiImpr/processPageSoggettiImpresa.action' />" method="post">
		<jsp:include page="/WEB-INF/plugins/ppcommon/aps/jsp/token_input.jsp" />
		
		<jsp:include page="/WEB-INF/plugins/ppgare/aps/jsp/internalServlet/datiimpresa/datiSoggettiSection.jsp" >
			<jsp:param name="namespace" value="DatiImpr" />
		...
		<div class="azioni">
			...
			<s:hidden name="tipoSoggettoDelete" value="%{tipoSoggettoDelete}"/>
		</div>
	</form>
