...
<div class="portgare-view">
	...
	<h2><wp:i18n key='TITLE_PAGE_RICHPART_ANNULLA_INVIO_DOCUMENTAZIONE'/></h2>

	<p><wp:i18n key='TITLE_PAGE_RICHPART_ANNULLA_INVIO_DOCUMENTAZIONE_1'/></p>
	<p><wp:i18n key='TITLE_PAGE_RICHPART_ANNULLA_INVIO_DOCUMENTAZIONE_2'/></p>
	...
	<div class="azioni">
		...
		<form action="<wp:action path="${href}" />" method="post" class="azione">
			...
			<wp:i18n key='BUTTON_WIZARD_BACK_TO_INVIO_DOCUMENTAZIONE' var='valueButtonBackTo' />
