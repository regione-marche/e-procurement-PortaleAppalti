...
<s:set name="importoOneriProgettazioneVisible" value="%{#gara.importoOneriProgettazioneVisible}"/>
<s:set name="importoOffertoVisible" value="%{#gara.importoOffertoVisible}"/>
<s:set name="importoOffertoEditable" value="%{#gara.importoOffertoEditable}"/>
<s:set name="importoOffertoMandatory" value="%{#gara.importoOffertoMandatory}"/>
<s:set name="percentualeRibassoEditable" value="%{#gara.percentualeRibassoEditable}"/>
<s:set name="percentualeRibassoMandatory" value="%{#gara.percentualeRibassoMandatory}"/>
<s:set name="percentualeAumentoVisible" value="%{#gara.percentualeAumentoVisible}"/>
<s:set name="percentualeAumentoEditable" value="%{#gara.percentualeAumentoEditable}"/>
<s:set name="importoOffertoPerPermutaVisible" value="%{#gara.importoOffertoPerPermutaVisible}"/>
<s:set name="importoOffertoCanoneAssistenzaVisible" value="%{#gara.importoOffertoPerCanoneAssistenzaVisible}"/>

<!-- Note per importo offerto -->
<s:set name="comprensivoNonSoggettiARibasso" value="%{#gara.comprensivoNonSoggettiARibasso}"/>
<s:set name="comprensivoOneriSicurezza" value="%{#gara.comprensivoOneriSicurezza}"/>
<s:set name="nettoOneriSicurezza" value="%{#gara.nettoOneriSicurezza}"/>
<s:set name="comprensivoOneriProgettazione" value="%{#gara.comprensivoOneriProgettazione}"/>
<s:set name="nonSuperioreAImportoBaseAsta" value="%{#gara.nonSuperioreAImportoBaseAsta}"/>
<s:set name="valoreMassimoImportoOfferto" value="%{#gara.valoreMassimoImportoOfferto}"/> 
