...
public class ApsAdminBaseTestCase extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		StrutsSpringObjectFactory ssf = new StrutsSpringObjectFactory(null, null, null, this._servletContext);
	...
	protected void initAction(String namespace, String name) throws Exception {
	    ...
	    this._proxy = proxyFactory.createActionProxy(namespace, name, null, true, false);
