...
public class OpenPageImpresaAction extends AbstractOpenPageAction {
    ...
    private void checkDatiImpresaHelper() {
		...
		try {
			...
			// NB: 
			// questa classe viene utilizzata anche per lo step "impresa" del wizard 
			// della richiesta di partecipazione solo per invio offerta/domanda di prequalifica
...
//					.get(PortGareSystemConstants.SESSION_ID_DETT_PART_GARA);
			...
			WizardPartecipazioneHelper partecipazioneHelper = (bustaPartecipazione != null ? bustaPartecipazione.getHelper() : null);			
