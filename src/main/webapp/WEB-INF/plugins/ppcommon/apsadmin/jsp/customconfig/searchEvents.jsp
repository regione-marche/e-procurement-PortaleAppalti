	...
	<fieldset>
		...
		<p>
			...
			<select name="model.type" id="model.type" class="text">
				...
				<option <s:if test="model.type=='USERVALID'">selected="selected"</s:if>
					value="USERVALID"><s:text
						name="ppcommon.searchEvents.label.search.type.USERVALID" /></option>
				...
				<option <s:if test="model.type=='AUTOSAVEFILE'">selected="selected"</s:if>
					value="AUTOSAVEFILE"><s:text
						name="ppcommon.searchEvents.label.search.type.AUTOSAVEFILE" /></option>
				...
				<option
					<s:if test="model.type=='ACCETTACONSENSI'">selected="selected"</s:if>
					value="ACCETTACONSENSI"><s:text
						name="ppcommon.searchEvents.label.search.type.ACCETTACONSENSI" /></option>
				<option
...
<!-- 			<table class="generic" style="display: block; overflow: auto;"> -->
				...
				<s:iterator var="event" value="%{risultati}">
					<tr>
						<td>
							<s:if test="%{#event.detailMessage != null && #event.detailMessage.length() > 0}">
