...
<div class="portgare-view">
	...
	<fieldset>
		...
		<div class="fieldset-row first-row">
			<s:if test="%{tipo == 'ricevute' || tipo=='archiviate' || tipo == 'soccorsiIstruttori'}" >
				<div class="label">
		...
		<div class="fieldset-row">
			...
			<div class="element">
				<s:set var="txt">${comunicazione.testo}</s:set>
				<span><s:property value="%{txt}" escape="<s:property value='%{doEscape}'/>" /></span>
			</div>
		</div>
	...
	<div class="azioni">
		<s:if test="%{!inviata && #attr.visInviaComunicazioni && !comunicazione.bloccaRispondi && !soccorsoScaduto}">
