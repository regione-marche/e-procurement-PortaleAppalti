...
********************************************************************************
	dettaglio.datiGeneraliBandoIscrizione.fase
		0 = iscrizione chiusa
		1 = iscrizione aperta 
		2 = iscrizione chiusa e termine validità non scaduto
...
<c:set var="validitaScaduta" 
	value="${now.time > dettaglio.datiGeneraliBandoIscrizione.dataFineValidita.time}" />
...
<c:set var="rinnovoIscrizione" value="${!validitaScaduta 
		&& dettaglio.datiGeneraliBandoIscrizione.fase != 0 && stato == 2 
...
<div class="portgare-view">
	...
	<h2><wp:i18n key="TITLE_PAGE_DETTAGLIO_ELENCO_OE" /></h2>

	<jsp:include page="/WEB-INF/plugins/ppcommon/aps/jsp/balloon_info.jsp">
		<jsp:param name="keyMsg" value="BALLOON_DETTAGLIO_BANDO_ISCRIZIONE" />
	</jsp:include>
...
--%>
	...
	<c:choose>
		...
		<c:when test="${empty param.ext}">
			<div class="back-link">
				<a href="<wp:action path="/ExtStr2/do/FrontEnd/Bandi/listAllIscrizione.action" />&amp;${tokenHrefParams}">
