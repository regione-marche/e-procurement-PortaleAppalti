...
public class CancelAggiornamentoAction extends BaseAction implements SessionAware {
	...
	private void clearSession() {
		this.session
			.remove(PortGareSystemConstants.SESSION_ID_PAGINA);	
		this.session
			.remove(PortGareSystemConstants.SESSION_ID_DETT_ANAGRAFICA_IMPRESA);
		this.session
			.remove(PortGareSystemConstants.SESSION_ID_URL_RITORNO_AGG_ANAGRAFICA_IMPRESA);
		this.session
			.remove(PortGareSystemConstants.SESSION_ID_MODULO_RITORNO_AGG_ANAGRAFICA_IMPRESA);
		this.session
			.remove(PortGareSystemConstants.SESSION_ID_ACTION_RITORNO_AGG_ANAGRAFICA_IMPRESA);
		this.session
			.remove(PortGareSystemConstants.SESSION_ID_FRAME_RITORNO_AGG_ANAGRAFICA_IMPRESA);
	}
