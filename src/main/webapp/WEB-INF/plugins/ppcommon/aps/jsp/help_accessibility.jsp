...
<p>Oltre alla visualizzazione normale con caratteri scuri su sfondo chiaro, è stato preparato un foglio di stile &quot;solo testo&quot;, attivabile tramite un collegamento nella parte superiore della pagina, e con il quale la visualizzazione viene ripulita da immagini e colorazioni, nonchè i contenuti delle varie aree vengono riportati uno sotto l'altro.</p>
<p> </p>
<h3>Contrasto</h3>
<p>E' stato preparato inoltre un foglio di stile ad &quot;alto contrasto&quot;, attivabile tramite un collegamento nella parte superiore della pagina, che consente di visualizzare le pagine in modalità solo testo ma con alto contrasto.</p>
<p> </p>
...
<p>* Con <strong>Internet Explorer</strong> utilizzare <strong>ALT + 'Carattere di riferimento' seguito da INVIO</strong></p>
<p>* Con <strong>Mozilla FireFox</strong> utilizzare <strong>ALT + MAIUSC + 'Carattere di riferimento'</strong></p>
<p>* Con <strong>Google Chrome</strong> utilizzare <strong>ALT + 'Carattere di riferimento'</strong></p>
<p>* Con <strong>Opera</strong> utilizzare <strong>MAIUSC + ESC + 'Carattere di riferimento'</strong></p>
<p>* Con <strong>Safari</strong> utilizzare <strong>ALT + 'Carattere di riferimento'</strong></p>
<hr />
...
<hr />
<h3>Testi</h3>
<p >Non sono stati utilizzati marcatori all'interno della pagina per definire caratteristiche del testo o dello sfondo ma si è ricorso ai Fogli di Stile CSS per gli effetti grafici. Inoltre le pagine sono state organizzate in modo che possano essere lette anche quando i fogli di stile siano disabilitati o non supportati.<br />In questo sito non si sono utilizzati frame e sono state evitati oggetti o scritte lampeggianti che possono provocare disturbi alla concentrazione o alle tecnologie assistive.<br />E' stato verificato un sufficiente contrasto di colore tra i testi e lo sfondo ed è stata accertata una uguale funzionalità in caso di assenza del colore utilizzato.<br />Nell'utilizzo di tabelle dati sono stati usati marcatori per identificare le intestazioni di righe e colonne con tag TH al posto dei tag TD per le celle di intestazione. Nel raro caso di tabelle di impaginazione si è verificato che il contenuto della tabella sia comprensibile anche se letta in modo linearizzato.</p>
<div><br /></div>
...
<p>Le pagine di questo sito sono state verificate con i seguenti browser:</p>
<div>
<ul>
<li>Sistema operativo Linux - risoluzione 1024 X 768: 
<ul>
<li>Firefox 1.5 - 2.0 - 3.0 </li>
</ul>
</li>
</ul>
<ul>
<li>Sistema operativo Windows XP - risoluzione 1024 X 768: <br />
<ul>
<li>Internet Explorer 7.0 - 8.0</li>
<li>Mozilla Firefox 1.5.0.9 - 2.0 - 3.0</li>
