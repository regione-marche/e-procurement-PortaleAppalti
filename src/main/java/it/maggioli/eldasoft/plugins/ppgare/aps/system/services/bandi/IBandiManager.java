...
public interface IBandiManager {
     ...
     *
     * @param stazioneAppaltante  stazione appaltante
     * @param oggetto             oggetto del bando di gara
     * @param cig                 codice cig del bando di gara
     * @param tipoAppalto         tipo di appalto (lavori/forniture/servizi)
     * @param dataPubblicazioneDa data pubblicazione a partire da
     * @param dataPubblicazioneA  data pubblicazione fino a
     * @param dataScadenzaDa      data scadenza a partire da
     * @param dataScadenzaA       data scadenza fino a
     * @param proceduraTelematica procedura telematica
     * @param stato               stato della gara
     * @return lista bandi
     ...
     *
     * @param codiceGara codice univoco della gara
     * @return cig
     * @throws ApsException In caso di errori in accesso al servizio web.
     */
    ...
    /**
     * Restituisce il dettaglio di una gara a partire dal cig
     *
     * @param codiceGara codice univoco della gara
     * @return dettaglio della gara, costituito dai suoi dati generali, quelli
     * della stazione appaltante, i documenti, chiarimenti e le
     ...
     * @throws ApsException In caso di errori in accesso al servizio web.
     */
    public DettaglioGaraType getDettaglioGaraByCig(String cig)
            throws ApsException;
    
    /**
     * ... 
     */
    public String getRagioneSocialeAnonima(String username, String ngara) throws ApsException;


    /**
     * Restituisce il dettaglio di una gara a partire da un suo lotto.
     *
     * @param codiceLotto codice univoco del lotto
     * @return dettaglio della gara, costituito dai suoi dati generali, quelli
     * della stazione appaltante, i documenti, chiarimenti e le
     * comunicazioni
     * @throws ApsException In caso di errori in accesso al servizio web.
    ...
    /**
     * Restituisce il codice di una gara a partire da un suo lotto.
     *
     * @param codiceLotto codice univoco del lotto
     * @return il codice delle gara 
     */
     ...
     * @param codice   codice univoco della gara/lotto/bando d'iscrizione
     * @param entita   (opzionale) codice del tipo di entita' (TORN, GARECONT, G1STIPULA, APPA, ...)
     ...
     *
     * @param username username dell'utente
     * @param codice   codice univoco della gara a lotti distinti
     * @param entita   (opzionale) codice del tipo di entita' (TORN, GARECONT, G1STIPULA, APPA, ...)
     * @return statistiche delle personali dell'utente
     * @throws ApsException In caso di errori in accesso al servizio web.
     */
     ...
     *
     * @param username            username dell'utente
     * @param codice              (opzionale) codice univoco della gara/lotto/bando d'iscrizione
     * @param soccorsoIstruttorio (opzionale) true per le comunicazioni di soccorso istruttorio, false per tutte le altre
     * @param entita              (opzionale) codice delle entita' da recuperare (TORN, GARECONT, G1STIPULE, APPA, etc)
     * @param indicePrimoRecord   indice del primo record da considerare, a partire da 0
     * @param maxNumRecord        numero massimo di record da estrarre, 0 per estrarli tutti
     ...
     *
     * @param username            username dell'utente
     * @param codiceGara          codice univoco della gara a lotti distinti
     * @param soccorsoIstruttorio (opzionale) true per le comunicazioni di soccorso istruttorio, false per tutte le altre
     * @param entita              (opzionale) codice delle entita' da recuperare (TORN, GARECONT, G1STIPULE, APPA, etc)
     * @param indicePrimoRecord   indice del primo record da considerare, a partire da 0
     * @param maxNumRecord        numero massimo di record da estrarre, 0 per estrarli tutti
     ...
     *
     * @param username        username dell'utente
     * @param idComunicazione id della comunicazione da estrarre
     * @param idDestinatario  progressivo del destinatario relativo alla comunicazione
     ...
     *
     * @param codiceGara  codice univoco della gara
     * @param codiceLotto codice univoco dell'eventuale lotto
     * @param tipoImpresa tipologia d'impresa
     * @param rti         impresa partecipa come rti
     * @param busta       tipologia di busta
     *                    <ul>
     ...
     *
     * @param idPrg           "PA" o "PG"
     * @param idComunicazione id della comunicazione
     ...
     *
     * @param username username dell'impresa
     * @param codice   codice univoco del bando di gara
     ...
     * @param progOfferta progressivo offerta
     ...
     *
     * @param username username dell'impresa
     * @param codice   codice del bando d'iscrizione
     ...
     *
     * @param codiceFiscale codice fiscale dell'impresa
     * @param partitaIva    partita iva dell'impresa
     * @param isGruppoIva   true se azienda italiana facente parte di un gruppo iva, false altrimenti
     ...
     * @param codiceFiscale codice fiscale dell'impresa
     * @param partitaIva    partita iva dell'impresa
     * @param email         email dell'impresa
     * @param pec           pec dell'impresa
     * @return true se esiste un'impresa che utilizza il portale ed &egrave;
     * identificata dal codice fiscale o dalla partita iva in input
     * @throws ApsException
     */
     ...
     *
     * @param codice codice del bando di gara
     ...
     *
     * @param codice codice univoco della stazione appaltante
     ...
     * mandataria in input.
     *
     * @param codiceProcedura codice della gara, oppure del bando iscrizione o del catalogo
     *                        elettronico
     * @param username        username dell'impresa mandataria
     ...
     *
     * @param username   identificativo impresa
     ...
     *
     * @param username          identificativo impresa
     * @param codice            codice procedura (elenco, catalogo)
     * @param tipiComunicazione lista di tipi di comunicazione da reperire
     ...
     *
     * @param codice   codice/codiceLotto univoco dell'asta
     * @param username codice della ditta
     ...
     *
     * @param tokenRichiedente identificativo impresa
     * @param codiceGara       codice/codiceLotto univoco della gara
     */
     ...
     *
     * @param codicegara       codice univoco della gara
     * @param codiceLotto      codiceLotto codice del lotto
     * @param fasegara         fase di gara
     * @param tokenRichiedente identificativo impresa
     */
     ...
     *
     * @param search       codice/codiceLotto univoco della gara
     */
     ...
     *
     * @param search           codice della gara
     */
    ...
    /**
     * Restituisce, per l'espletamento di gara, l'elenco degli operatori economici
     * classificati come 1,2,3,4,5 e i relativi documenti 
     *
     * @param search       codice/codiceLotto univoco della gara
     */
    ...
    /**
     * Restituisce, per l'espletamento di gara, i documenti di una classificata o la documentazione di gara
     *
     * @param search       codice univoco della gara
     */
     ...
     *
     * @param codice codice/codiceLotto univoco della gara
     */
...
//    		String codice) throws ApsException;
     ...
     *
     * @param codice codice/codice lotto
    ...
    /**
     * Restituisce il dettaglio di una delibera a contrarre
     *
     * @throws ApsException In caso di errori in accesso al servizio web.
     */
     ...
     * @param altrisoggetti
     * @param sommaUrgenza
     * @param garaPrivatistica    2=acquisto, 1=vendita
     * @return lista bandi scaduti
     * @throws ApsException In caso di errori in accesso al servizio web.
     */
     ...
     * @param codice   codice gara/lotto del bando
     */
    ...
    boolean isConcorsoCrypted(String username, String codice) throws ApsException;
    String isConcorsoAttachedToRTI(String username, String codice) throws ApsException;

    TipoPartecipazioneDocument getPartecipantiRaggruppamento(String username, String codice) throws ApsException;

    String getCodiceSecondoGrado(String username, String codice) throws ApsException;

    boolean canShowRankingFirstGradeCompetition(String ngara) throws ApsException;
    
    /**
     * restituisce l'elenco delle imprese ausiliarie relative ad un avvalimento
     */
    public List<ImpresaAusiliariaType> getImpreseAusiliarie(
    		String username, 
    		String codice, 
    		String progOfferta) throws ApsException;
