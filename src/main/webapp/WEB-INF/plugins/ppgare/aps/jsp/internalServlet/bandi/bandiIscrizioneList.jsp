...
<div class="portgare-list">
    ...
    <s:if test="%{isAttivo == null || isAttivo}">
        <c:set var="titleKey" value="TITLE_PAGE_LISTA_ELENCHI_OE" />
        <c:set var="balloonKey" value="BALLOON_LISTA_BANDI_ISCRIZIONE" />
    </s:if>
    <s:else>
        <c:set var="titleKey" value="TITLE_PAGE_LISTA_ELENCHI_OE_ARCHIVIATI" />
        <c:set var="balloonKey" value="BALLOON_LISTA_BANDI_ISCRIZIONE_ARCHIVIATI" />
    </s:else>
