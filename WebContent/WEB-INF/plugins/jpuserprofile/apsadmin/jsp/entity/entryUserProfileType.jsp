...
<%-- INIZIO PARTE AGGIUNTA PER TIPO ENTITA' PROFILO UTENTE --%>
<fieldset><legend><s:text name="label.metadata" /></legend>
<wpsa:set var="allowedDefaultAttributes" value="allowedDefaultAttributes" />

<p>
	<label for="firstNameAttributeName"><s:text name="name.firstNameAttributeName" />:</label><br /> 
	<wpsf:select name="firstNameAttributeName" id="firstNameAttributeName" list="#allowedDefaultAttributes" listKey="name" listValue="name" headerKey="" headerValue="" value="%{#entityType.firstNameAttributeName}" />
</p>

<p>
	<label for="surnameAttributeName"><s:text name="name.surnameAttributeName" />:</label><br />
	<wpsf:select name="surnameAttributeName" id="surnameAttributeName" list="#allowedDefaultAttributes" listKey="name" listValue="name" headerKey="" headerValue="" value="%{#entityType.surnameAttributeName}" />
</p>

<p>
	<label for="mailAttributeName"><s:text name="name.mailAttributeName" />:</label><br /> 
	<wpsf:select name="mailAttributeName" id="mailAttributeName" list="#allowedDefaultAttributes" listKey="name" listValue="name" headerKey="" headerValue="" value="%{#entityType.mailAttributeName}" />
</p>

</fieldset>
<%-- FINE PARTE AGGIUNTA PER TIPO ENTITA' PROFILO UTENTE --%>
