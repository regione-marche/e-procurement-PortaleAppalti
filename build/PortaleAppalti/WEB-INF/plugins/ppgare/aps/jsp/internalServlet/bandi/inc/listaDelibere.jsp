					...
					<s:if test="%{idDoc != null}">
						...
						<s:if test='#docFirmato' >
							...
							<form action='${urlFileApriFileFirmato}' method="post" style="display:inline">
		    					...
		    					<a href="javascript:;" onclick="parentNode.submit();" title="<wp:i18n key="LABEL_INFO_FIRMA_DIGITALE" />" class='bkg download'>
		    						<s:property value='%{descrizioneDoc}'/>
		    					</a>
		   						<input type="hidden" name="codice" value="<s:property value='%{idDoc}'/>" />
