...
public class ProcessPageOffertaAction extends AbstractProcessPageAction {
	...
	public ProcessPageOffertaAction() {
		super(PortGareSystemConstants.SESSION_ID_OFFERTA_ECONOMICA,
...
//			String nextPage = InitOffertaEconomicaAction
//				.setNextResultAction(helper
//						.getNextStepNavigazione(WizardOffertaEconomicaHelper.STEP_OFFERTA));
//		
//			// verifica se le sommatorie delle voci (soggette a ribasso, non soggette
//			// a ribasso, sicurezza) corrispondono ai rispettivi totali dell'offerta
//			// ed eventualmente blocca la compilazione degli step successivi
//			//		0   ok
...
//			int err = isTotaliLavorazioniCorretti(this.session);
//			if( err > 0 ) {
//				this.addActionError(this.getText("Errors.offertaTelematica.totaliPrezziUnitari.diversi"));
//				if((err & 1) != 0) {
//					this.addActionError("Totale voci solo sicurezza non coerente con l'offerta");
//				}
//				if((err & 2) != 0) {
//					this.addActionError("Totale voci non soggette a ribasso non coerente con l'offerta");
//				}
//				if((err & 4) != 0) {
//					this.addActionError("Totale voci soggette a ribasso non coerente con l'offerta");
//				}				
//				nextPage = InitOffertaEconomicaAction
//					.setNextResultAction(WizardOffertaEconomicaHelper.STEP_OFFERTA);				
//			}			
//				
//			this.nextResultAction = nextPage;
	...
	private boolean isOffertaChanged(WizardOffertaEconomicaHelper helper) {
		...
		return (variazioneImporto || variazioneRibasso || variazioneAumento || 
				...
				variazioneCriteriValidazione) || helper.isRigenPdf();
	}
