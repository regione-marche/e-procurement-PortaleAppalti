...
public class StringUtilities {
	...
	/**
	 * Converte i caratteri in utf-8 in seguito alla submit di un form in multipart contenente di testo descrittivi 
	 * 
	 * @param String field
	 * @return stringa formattata con codifica utf-8
	 */
	public static String fixEncodingMultipartField(String field){
		String fixedString = field;
		try {
			fixedString = new String (field.getBytes ("iso-8859-1"), "UTF-8");
