...
public class DispatchAction extends BaseAction implements IDispatchAction,
	...
	public void validate() {
		...
		// in sessione.
		int status = Authenticator.doAuthentication(this.getRequest(),
				ControllerManager.CONTINUE, this._authenticationProvider,
				this._userManager, this._appParamManager,
				this._applicationContext, this._eventManager, log, this);
