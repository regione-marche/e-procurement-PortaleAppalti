...
public class ComunicazioniManager extends AbstractService implements
	...
	@Override
	public void deleteAllegatoProtocollo(String entita, String applicativo, long id) throws ApsException {
		try {
			ErroreOutType retWS = this.wsOpGenerali.getProxyWSOPGenerali()
					.deleteAllegatoProtocollo(entita, applicativo, id);
			if (retWS.getErrore() != null)
				throw new ApsException(
						"Errore durante l'eliminazione di un allegato del protocollo ("
								+ entita
								+ ","
								+ applicativo
								+ ","
