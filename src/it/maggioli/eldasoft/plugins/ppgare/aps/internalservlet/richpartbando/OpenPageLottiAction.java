...
public class OpenPageLottiAction extends BaseAction implements SessionAware {
	...
	public String openPage() {
		...
		if (partecipazioneHelper == null) {
			...
			try {
				boolean domandaPartecipazione = (PortGareSystemConstants.TIPOLOGIA_EVENTO_PARTECIPA_GARA == partecipazioneHelper.getTipoEvento());
				boolean ristretta = (partecipazioneHelper.getIterGara() == 2 || partecipazioneHelper.getIterGara() == 4);
				
				LottoGaraType[] lottiGara = null;
				
				switch (partecipazioneHelper.getTipoEvento()) {
				case 1:		// 1 == PortGareSystemConstants.TIPOLOGIA_EVENTO_PARTECIPA_GARA
					lottiGara = this.bandiManager.getLottiGaraPerDomandePartecipazione(
							partecipazioneHelper.getIdBando());
					break;
					
				case 2:		// 2 == PortGareSystemConstants.TIPOLOGIA_EVENTO_INVIA_OFFERTA
					...
					// se non è mai stata aperta la compilazione dell'offerta,
				...
				case 3:		// 3 == PortGareSystemConstants.TIPOLOGIA_EVENTO_COMPROVA_REQUISITI
