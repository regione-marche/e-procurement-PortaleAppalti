...
public abstract class ListAttributeAction extends BaseAction implements IListAttributeAction {
	...
	public String addListElement() {
		...
		try {
			...
			log.trace("Added element of type " + currentAttribute.getNestedAttributeTypeCode() + " to the list " + currentAttribute.getName());
		} catch (Throwable t) {
	...
	public String moveListElement() {
		...
		try {
			...
			log.trace("Moved element of type " + currentAttribute.getNestedAttributeTypeCode() + 
	...
	public String removeListElement() {
		...
		try {
			...
			log.trace("Element oy type " + currentAttribute.getNestedAttributeTypeCode() + " removed fomr the list " + currentAttribute.getName());
		} catch (Throwable t) {
