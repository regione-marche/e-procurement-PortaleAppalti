...
<dl class="gallery">
<dt class="image"><a href="<s:property value="%{#resource.documentPath}" />" ><img src="<wp:resourceURL/>administration/img/icons/resourceTypes/<s:property value="%{getIconFile(#resourceInstance.fileName)}"/>" alt="<s:property value="%{#resourceInstance.fileName}"/>" title="<s:property value="%{#resourceInstance.fileName}"/>" /></a><br /><s:property value="%{#resourceInstance.fileLength}"/></dt>
<dt class="options">
	<s:if test="onEditContent">
