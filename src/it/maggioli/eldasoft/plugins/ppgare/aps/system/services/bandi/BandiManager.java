...
import it.eldasoft.www.sil.WSGareAppalto.CategorieBandoIscrizioneOutType;
import it.eldasoft.www.sil.WSGareAppalto.CategorieImpresaPerIscrizioneOutType;
import it.eldasoft.www.sil.WSGareAppalto.CategorieOperatoriIscrittiOutType;
import it.eldasoft.www.sil.WSGareAppalto.CheckAggiornamentoIscrizionePosticipataOutType;
import it.eldasoft.www.sil.WSGareAppalto.CheckDimensioneDocumentiOutType;
import it.eldasoft.www.sil.WSGareAppalto.CheckDocumentiNulliOutType;
import it.eldasoft.www.sil.WSGareAppalto.ComunicazionePersonaleOutType;
import it.eldasoft.www.sil.WSGareAppalto.ComunicazioneType;
import it.eldasoft.www.sil.WSGareAppalto.ComunicazioniPersonaliOutType;
import it.eldasoft.www.sil.WSGareAppalto.DeliberaType;
import it.eldasoft.www.sil.WSGareAppalto.DelibereOutType;
...
import it.eldasoft.www.sil.WSGareAppalto.DettaglioGaraOutType;
...
import it.eldasoft.www.sil.WSGareAppalto.ElencoBandiOutType;
import it.eldasoft.www.sil.WSGareAppalto.ElencoInviiOutType;
...
import it.eldasoft.www.sil.WSGareAppalto.GetAbilitazioniGaraOutType;
import it.eldasoft.www.sil.WSGareAppalto.GetAttiDocumentiBandoGaraOutType;
import it.eldasoft.www.sil.WSGareAppalto.GetAttributiAggiuntiviOffertaOutType;
import it.eldasoft.www.sil.WSGareAppalto.GetDatiImpresaOutType;
import it.eldasoft.www.sil.WSGareAppalto.GetDettaglioStazioneAppaltanteOutType;
import it.eldasoft.www.sil.WSGareAppalto.GetDocumentiInvitoAstaLottoOutType;
import it.eldasoft.www.sil.WSGareAppalto.GetDocumentiRichiestiBandoGaraPlicoUnicoOutType;
import it.eldasoft.www.sil.WSGareAppalto.GetDocumentiRichiestiBandoOutType;
import it.eldasoft.www.sil.WSGareAppalto.GetEspletamentoGaraElencoOperatoriOutType;
import it.eldasoft.www.sil.WSGareAppalto.GetFascicoloProtocolloOutType;
import it.eldasoft.www.sil.WSGareAppalto.GetMandantiRTIOutType;
import it.eldasoft.www.sil.WSGareAppalto.GetStatisticheComunicazioniPersonaliOutType;
import it.eldasoft.www.sil.WSGareAppalto.GetStazioniAppaltantiOutType;
import it.eldasoft.www.sil.WSGareAppalto.GetVociDettaglioOffertaOutType;
import it.eldasoft.www.sil.WSGareAppalto.ImpresaIscrizioneOutType;
import it.eldasoft.www.sil.WSGareAppalto.ImpresaIscrizioneType;
import it.eldasoft.www.sil.WSGareAppalto.InvioType;
import it.eldasoft.www.sil.WSGareAppalto.InvitiGaraOutType;
import it.eldasoft.www.sil.WSGareAppalto.InvitoGaraType;
import it.eldasoft.www.sil.WSGareAppalto.LottiGaraOutType;
...
import it.eldasoft.www.sil.WSGareAppalto.OperatoriIscrittiOutType;
...
import it.eldasoft.www.sil.WSGareAppalto.RisultatoStringaOutType;
import it.eldasoft.www.sil.WSGareAppalto.SommaUrgenzaOutType;
...
import it.eldasoft.www.sil.WSGareAppalto.StatoIscrizioneABandoIscrizioneOutType;
import it.eldasoft.www.sil.WSGareAppalto.TipoPartecipazioneImpresaOutType;
import it.eldasoft.www.sil.WSGareAppalto.TipoPartecipazioneType;
import it.eldasoft.www.sil.WSGareAppalto.VersionOutType;
import it.eldasoft.www.sil.WSGareAppalto.VoceDettaglioOffertaType;
import it.eldasoft.www.sil.WSGareAppalto.WSDMConfigOutType;
...
public class BandiManager extends AbstractService implements IBandiManager {
	 ...
	 * ...
	 */
	public SearchResult<GaraType> searchBandi(
	...
	{
		SearchResult<GaraType> bandi = new SearchResult<GaraType>();
		...
		try {
			...
			retWS = wsGareAppalto.getProxyWSGare().searchBandi(
					stazioneAppaltante, 
					oggetto, 
					cig, 
					tipoAppalto,
	...
	@Override
	public SearchResult<GaraType> getElencoBandi(
			String stazioneAppaltante,
			String oggetto, 
			String cig, 
			String tipoAppalto,
			...
			int maxNumRecord) throws ApsException 
	{
		...
		try {
			...
			retWS = wsGareAppalto.getProxyWSGare().getElencoBandi(
					stazioneAppaltante, 
					oggetto, 
					cig, 
					tipoAppalto,
	...
	@Override
	public SearchResult<GaraType> getElencoBandiScaduti(
			String stazioneAppaltante,
			String oggetto, 
			String cig, 
			String tipoAppalto,
			...
			int maxNumRecord) throws ApsException 
	{
		...
		try {
			...
			retWS = wsGareAppalto.getProxyWSGare().getElencoBandiScaduti(
					stazioneAppaltante, 
					oggetto, 
					cig, 
					tipoAppalto,
	...
	throws ApsException {
		...
		try {
			retWS = wsGareAppalto.getProxyWSGare().getDettaglioGaraFromLotto(
					codiceLotto);
			if (retWS.getErrore() == null)
				dettaglio = retWS.getGara();
			else {
	...
	@Override
	public LottoGaraType[] getLottiGaraPerDomandePartecipazione(String codiceGara) throws ApsException {
		LottoGaraType[] dettaglio = null;
		LottiGaraOutType retWS = null;
		try {
			retWS = wsGareAppalto.getProxyWSGare().getLottiGaraPerDomandePartecipazione(codiceGara);
			if (retWS.getErrore() == null)
				dettaglio = retWS.getLotto();
			else {
				// se si verifica un errore durante l'estrazione dei dati con il
	...
	@Override
	public LottoGaraType[] getLottiGaraPerRichiesteOfferta(String username,
			String codiceGara) throws ApsException {
		LottoGaraType[] dettaglio = null;
		LottiGaraOutType retWS = null;
		try {
			retWS = wsGareAppalto.getProxyWSGare().getLottiGaraPerRichiesteOfferta(username,
					codiceGara);
			if (retWS.getErrore() == null)
				dettaglio = retWS.getLotto();
			else {
	...
	@Override
	public LottoGaraType[] getLottiGaraPlicoUnicoPerRichiesteOfferta(String username,
			String codiceGara) throws ApsException {
		LottoGaraType[] dettaglio = null;
		LottiGaraOutType retWS = null;
		try {
			retWS = wsGareAppalto.getProxyWSGare().getLottiGaraPlicoUnicoPerRichiesteOfferta(username,
					codiceGara);
			if (retWS.getErrore() == null)
				dettaglio = retWS.getLotto();
			else {
	...
	public List<BandoIscrizioneType> searchBandiIscrizione(String username,
			Integer stato) throws ApsException {
		...
		try {
			...
			retWS = wsGareAppalto.getProxyWSGare().searchBandiIscrizione(
					username, stato, stazioneAppaltante);
			if (retWS.getErrore() == null) {
	...
	@Override
	public List<BandoIscrizioneType> getElencoBandiIscrizione() throws ApsException {
		List<BandoIscrizioneType> bandi = null;
		ElencoBandiIscrizioneOutType retWS = null;
		try {
			String stazioneAppaltante = BandiManager.getApplicationFilter(
			...
			retWS = wsGareAppalto.getProxyWSGare().getElencoBandiIscrizione(stazioneAppaltante);
			if (retWS.getErrore() == null) {
				if (retWS.getElencoBandiIscrizione() != null)
					bandi = Arrays.asList(retWS.getElencoBandiIscrizione());
				else
	...
	public StatisticheComunicazioniPersonaliType getStatisticheComunicazioniPersonali(
		...
		try {
			...
			retWS = wsGareAppalto.getProxyWSGare()
				.getStatisticheComunicazioniPersonali(username, codice, 
						stazioneAppaltante);
			if (retWS.getErrore() == null)
	...
	public StatisticheComunicazioniPersonaliType getStatisticheComunicazioniPersonaliGaraLotti(
			String username, String codiceGara) throws ApsException {
		StatisticheComunicazioniPersonaliType dettaglio = null;
		GetStatisticheComunicazioniPersonaliOutType retWS = null;
		try {
			String stazioneAppaltante = BandiManager.getApplicationFilter(
			...
			retWS = wsGareAppalto.getProxyWSGare()
				.getStatisticheComunicazioniPersonaliGaraLotti(username, 
	...
	public SearchResult<ComunicazioneType> getComunicazioniPersonaliInviate(
			String username, String codice, int indicePrimoRecord,
			int maxNumRecord) throws ApsException {
		SearchResult<ComunicazioneType> risultato = new SearchResult<ComunicazioneType>();
		List<ComunicazioneType> comunicazioni = null;
		ComunicazioniPersonaliOutType retWS = null;
		try {
			...
			retWS = wsGareAppalto.getProxyWSGare()
				.getComunicazioniPersonaliInviate(username, codice,
					indicePrimoRecord, maxNumRecord, 
					stazioneAppaltante);
			if (retWS.getErrore() == null) {
				if (retWS.getComunicazione() != null) {
	...
	public ComunicazioneType getComunicazioneRicevuta(
			...
			long idDestinatario) throws ApsException 
	{
	...
	public ComunicazioneType getComunicazioneInviata(String username,
			long idComunicazione) throws ApsException {
		ComunicazioneType dettaglio = null;
		ComunicazionePersonaleOutType retWS = null;
		try {
			retWS = wsGareAppalto.getProxyWSGare()
	...
	public Integer getStatoIscrizioneABandoIscrizione(String username,
		...
		try {
			retWS = wsGareAppalto.getProxyWSGare().getStatoIscrizioneABandoIscrizione(username,
					codice);
			if (retWS.getErrore() == null)
	...
	@Override
	public SearchResult<GaraType> getElencoBandiPerRichiesteOfferta(
			String username,
			String stazioneAppaltante,
			String oggetto, 
			String cig, 
			...
			int maxNumRecord) throws ApsException 
	{
		...
		try {
			...
			retWS = wsGareAppalto.getProxyWSGare().getElencoBandiPerRichiesteOfferta(
					username,
					stazioneAppaltante, 
					oggetto, 
					cig, 
	...
	@Override
	public SearchResult<GaraType> getElencoBandiPerRichiesteCheckDocumentazione(
			String username,
			String stazioneAppaltante,
			String oggetto, 
			String cig, 
	...
	@Override
	public SearchResult<GaraType> getElencoBandiPerAsteInCorso(
			String username,
			String stazioneAppaltante,
			String oggetto, 
			String cig, 
			...
			int maxNumRecord) throws ApsException 
	{
		...
		try {
			...
			retWS = wsGareAppalto.getProxyWSGare().getElencoBandiPerAsteInCorso(
					username,
					stazioneAppaltante, 
					oggetto, 
					cig, 
...
//			Date dataPubblicazioneDa, Date dataPubblicazioneA,
			Date dataScadenzaDa, Date dataScadenzaA,
			Boolean proceduraTelematica, 
			String stato) throws ApsException 
	{
		int numBandi = 0;
		ElencoBandiOutType retWS = null;
		try {
			...
			retWS = wsGareAppalto.getProxyWSGare().countBandiPerAsteInCorso(
					username,
					stazioneAppaltante, 
					oggetto, 
					cig, 
...
//					(dataPubblicazioneA != null ? DateUtils.toCalendar(dataPubblicazioneA) : null),
	...
	throws ApsException {
		...
		EsitoOutType retWS = null;
		try {
			retWS = wsGareAppalto.getProxyWSGare().isImpresaRegistrata(codiceFiscale, partitaIva);
			if (retWS.getErrore() == null) {
				esito = retWS.getEsito();
			} else {
				// se si verifica un errore durante l'estrazione dei dati con il
	...
	@Override
	public SearchResult<GaraType> searchBandiPerProcInAggiudicazione(
			String username,
			String stazioneAppaltante,
			String oggetto, 
			String cig, 
			...
			int maxNumRecord) throws ApsException 
	{
		...
		try {
			...
			retWS = wsGareAppalto.getProxyWSGare().searchBandiPerProcInAggiudicazione(
					username,
					stazioneAppaltante, 
					oggetto, 
					cig, 
	...
	@Override
	public SearchResult<GaraType> searchBandiConEsito(
			String stazioneAppaltante,
			String oggetto, 
			String cig, 
			String tipoAppalto,
			...
			int maxNumRecord) throws ApsException 
	{
		...
		try {
			...
			retWS = wsGareAppalto.getProxyWSGare().searchBandiConEsito(
					stazioneAppaltante, 
					oggetto, 
					cig, 
					tipoAppalto,
		...
		try {
			...
			if (retWS.getErrore() == null) {
				if (retWS.getElenco() != null)
					...
					voci = new ArrayList<VoceDettaglioOffertaType>();
			} else {
				// se si verifica un errore durante l'estrazione dei dati con il
				// servizio, allora si ritorna un'eccezione che contiene il
				// messaggio di errore
		...
		try {
			...
			if (retWS.getErrore() == null) {
				if (retWS.getElenco() != null)
					...
					attributi = new ArrayList<AttributoAggiuntivoOffertaType>();
			} else {
				// se si verifica un errore durante l'estrazione dei dati con il
				// servizio, allora si ritorna un'eccezione che contiene il
				// messaggio di errore
		...
		try {
			...
			if (retWS.getErrore() == null) {
				if (retWS.getElenco() != null)
					...
					elenco = new ArrayList<DettaglioStazioneAppaltanteType>();
			} else {
				// se si verifica un errore durante l'estrazione dei dati con il
				// servizio, allora si ritorna un'eccezione che contiene il
				// messaggio di errore
			...
			String progOfferta) throws ApsException 
	{
		...
		try {
			retWS = wsGareAppalto.getProxyWSGare().getMandantiRTI(
					codiceProcedura, username, progOfferta);
			if (retWS.getErrore() == null) {
				if (retWS.getElenco() != null)
					mandanti = Arrays.asList(retWS.getElenco());
				else
					mandanti = new ArrayList<MandanteRTIType>();
			} else {
				// se si verifica un errore durante l'estrazione dei dati con il
				// servizio, allora si ritorna un'eccezione che contiene il
				// messaggio di errore
	...
	public FascicoloProtocolloType getFascicoloProtocollo(String codiceProcedura)
		...
		try {
			retWS = wsGareAppalto.getProxyWSGare().getFascicoloProtocollo(
					codiceProcedura);
			if (retWS.getErrore() == null)
	...
	public byte[] getChiavePubblica(String codice, String tipoBusta)
		...
		byte[] risultato = null;
		try {
			RisultatoStringaOutType retWS = wsGareAppalto.getProxyWSGare()
					.getChiavePubblica(codice, tipoBusta);
			if (retWS.getErrore() == null) {
	...
	public boolean isConsorziateEsecutriciPresenti(String username, String codiceGara)
		...
		try {
			retWS = wsGareAppalto.getProxyWSGare()
					.isConsorziateEsecutriciPresenti(username, codiceGara);
			if (retWS.getErrore() == null) {
				esito = retWS.getEsito();
			} else {
				// se si verifica un errore durante l'estrazione dei dati con il
		...
		try {
			...
			if (retWS.getErrore() == null) {
				if (retWS.getInvio() != null)
					...
					attributi = new ArrayList<InvioType>();
			} else {
				// se si verifica un errore durante l'estrazione dei dati con il
				// servizio, allora si ritorna un'eccezione che contiene il
				// messaggio di errore
...
//	}
     ...
     */ 
	@Override
	public SearchResult<GaraType> getElencoBandiScadutiPrivatistiche(
			String stazioneAppaltante,
			String oggetto, 
			String cig, 
			String tipoAppalto,
			...
			int maxNumRecord) throws ApsException 
	{
		...
		try {
			...
			retWS = wsGareAppalto.getProxyWSGare().getElencoBandiScadutiPrivatistiche(
					stazioneAppaltante, 
					oggetto, 
					cig, 
					tipoAppalto,
	...
	@Override
	public SearchResult<GaraType> getElencoBandiPerRichiesteOffertaPrivatistiche(
			String username,
			String stazioneAppaltante,
			String oggetto, 
			String cig, 
			...
			int maxNumRecord) throws ApsException 
	{
		...
		try {
			...
			retWS = wsGareAppalto.getProxyWSGare().getElencoBandiPerRichiesteOffertaPrivatistiche(
					username,
					stazioneAppaltante, 
					oggetto, 
					cig, 
	...
	@Override
	public SearchResult<GaraType> getElencoBandiPrivatistiche(
			String stazioneAppaltante,
			String oggetto, 
			String cig, 
			String tipoAppalto,
			...
			int maxNumRecord) throws ApsException 
	{
		...
		try {
			...
			retWS = wsGareAppalto.getProxyWSGare().getElencoBandiPrivatistiche(
					stazioneAppaltante, 
					oggetto, 
					cig, 
					tipoAppalto,
	...
	@Override
	public SearchResult<GaraType> searchBandiPerProcInAggiudicazionePrivatistiche(
			String username,
			String stazioneAppaltante,
			String oggetto, 
			String cig, 
			...
			int maxNumRecord) throws ApsException 
	{
		...
		try {
			...
			retWS = wsGareAppalto.getProxyWSGare().searchBandiPerProcInAggiudicazionePrivatistiche(
					username,
					stazioneAppaltante, 
					oggetto, 
					cig, 
	...
	public List<InvitoGaraType> getElencoInvitiGara(
				...
				String codiceGara) throws ApsException
	{
		List<InvitoGaraType> inviti = new ArrayList<InvitoGaraType>();
