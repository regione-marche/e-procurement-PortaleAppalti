			...
			<table id="tableLotti" summary="Tabella lotti" class="info-table">
				...
				<tbody>
					<s:iterator var="item" value="lotti" status="stat">
						<tr>
							<td class="azioni">
								<a href="<wp:action path="/ExtStr2/do/FrontEnd/GareTel/espletGaraViewValTec.action"/>&amp;codice=${param.codice}&amp;codiceLotto=<s:property value="%{#item.lotto}"/>&amp;${tokenHrefParams}"
