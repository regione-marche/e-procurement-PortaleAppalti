				...
				<div class="fieldset-row last-row">
					<div class="label">
						<label><wp:i18n key="LABEL_DOCUMENTI_ALLEGATI"/> (<s:property
								value="%{#helper.documenti.docRichiestiId.size() + #helper.documenti.docUlterioriDesc.size()}" />)
						</label>
					</div>
					<div class="element">
						<s:iterator value="documentiRichiesti" var="doc">
							<s:iterator
								value="#helper.documenti.docRichiestiId"
								var="idDoc" status="stat">
						...
						<s:iterator
							value="#helper.documenti.docUlterioriDesc"
							var="doc" status="stat">
